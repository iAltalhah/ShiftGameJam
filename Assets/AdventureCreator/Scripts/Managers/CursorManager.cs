	...
	public class CursorManager : ScriptableObject
	{
		...
		private void IconsGUI (System.Action<ActionListAsset> showALAEditor)
		{
			...
			foreach (CursorIcon _cursorIcon in cursorIcons)
			{
				...
				_cursorIcon.ShowGUI (CursorIconBase.IncludeSize.OnlyIfSoftware, true, "Texture:", cursorRendering, "AC.KickStarter.cursorManager.GetCursorIconFromID (" + i + ")", "The icon's texture");
		...
		private void IconBaseGUI (string fieldLabel, CursorIconBase icon, string apiPrefix, string tooltip = "", bool includeAlwaysAnimate = true)
		{
			...
			icon.ShowGUI (CursorIconBase.IncludeSize.OnlyIfSoftware, includeAlwaysAnimate, "Texture:", cursorRendering, apiPrefix, tooltip);
